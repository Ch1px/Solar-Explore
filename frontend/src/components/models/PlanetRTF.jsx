...
export default function Planets(props) {
  ...
  return (
    ...
    <group {...props} dispose={null}>
      ...
      {isClickedBelt && <Html position={[null]}><div id='containerBelt'><h1 id='name'>Kuiper Belt</h1><p id='planet'></p></div></Html>}

      {isClickedMoon && <Html position={[null]}><div id='containerMoon'><h1 id='name'>The Moon</h1><p id='planet'></p></div></Html>}
